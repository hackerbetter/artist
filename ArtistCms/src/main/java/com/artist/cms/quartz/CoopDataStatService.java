...
public class CoopDataStatService {
	...
	private Logger logger = LoggerFactory.getLogger(CoopDataStatService.class);
	...
	public void singleCoopStat(String coopid, String coopname, Integer rate, Date date) {
		...
		builder2.append(" date_format(o.regtime, '%Y-%m-%d')<=? and");
		params2.add(oneDay);
		...
		builder4.append(" date_format(o.regtime, '%Y-%m-%d')=? and");
		params4.add(oneDay);
